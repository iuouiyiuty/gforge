...
type schemaArg struct {
	...
	Model     string `cli:"m" usage:"model"`
	ModelPkg  string `cli:"M" usage:"model package"`
}
...
var daoCommand = &cli.Command{
	...
	Fn: func(ctx *cli.Context) error {
		...
		//io.Copy(&buff, addImport(arg.Pkg))
		//structName, err := getSchema(&buff, arg)
		//if nil != err {
		//	return err
		//}
		r, err := dao.GenerateDao(arg.TableName, arg.Model, arg.ModelPkg)
		if nil != err {
			return err
		}
